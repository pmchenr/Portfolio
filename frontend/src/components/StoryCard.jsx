...
export default function StoryCard({
    ...
    return (
        <article
            className={`group overflow-hidden rounded-brand border border-line bg-paper shadow-card hover:shadow-lg transition-shadow ${
                tall ? 'row-span-2' : ''
            }`}
        >
            ...
            <div className="p-5">
                ...
                {excerpt && (
                    <p className="text-ash mt-2 line-clamp-3">{excerpt}</p>
                )}
                <div className="mt-4">
                    <Link
                        to={to}
